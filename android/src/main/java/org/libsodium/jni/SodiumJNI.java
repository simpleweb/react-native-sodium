...
public class SodiumJNI {
  ...
  public final static native int crypto_box_seal(byte[] c, final byte[] m, final long mlen, final byte[] pk);
  public final static native int crypto_box_seal_open(byte[] m, final byte[] c, final long clen, final byte[] pk, final byte[] sk);
